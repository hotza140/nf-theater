                                                ...
                                                <tr class="num" id="{{$items->id}}">
                                                    ...
                                                    <td style="text-align: center">
                                                        <button class="btn btn-warning btn-sm"
                                                            onclick="ShowSlipImg({{$items->id}},'{{$items->imgSlip}}','Truewallet',1);"
                                                            >Load</button>
...
<script>
    ...
    // Example usage:
    // const base64String = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAA..."; // Example Base64 string
    // saveBase64AsFile(base64String, "image.png", "image/png");
