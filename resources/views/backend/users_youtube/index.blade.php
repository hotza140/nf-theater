                                ...
                                <div class="card-block">
                                    <div class="dt-responsive table-responsive">
                                        <table id="" class="table table-striped table-bordered nowrap">
                                            ...
                                            <?php  $t_users = App\Models\users::whereNotNull('type_youtube')->where('id','!=',$items->id)->where('username',$items->username)->orderBy('id','asc')->get();  ?>
                                            <tr class="num" id="{{$items->id}}">
                                                    ...
                                                    $today = $t_userss->date_start; // วันที่ปัจจุบัน
